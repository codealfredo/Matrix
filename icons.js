// Colección de iconos SVG minimalistas inspirados en Lucide Icons para "Matrix - Estructura de la Vida"
window.ICONS = {
  ...
  utensils: `<path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2" /><path d="M7 2v4" /><path d="M18 8v13M14 2v3a5 5 0 0 0 5 5h0a5 5 0 0 0 5-5V2" />`,
  ...
  palette: `<circle cx="13.5" cy="6.5" r=".5" fill="currentColor" /><circle cx="17.5" cy="10.5" r=".5" fill="currentColor" /><circle cx="8.5" cy="7.5" r=".5" fill="currentColor" /><circle cx="6.5" cy="12.5" r=".5" fill="currentColor" /><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.92 0 1.63-.77 1.63-1.7 0-.43-.16-.83-.41-1.16a.78.78 0 0 1-.18-.5c0-.45.36-.81.81-.81H16c4.42 0 8-3.58 8-8 0-4.42-3.58-8-8-8Z" />`,
...
window.getIconSvg = function(name, size = 20, className = '') {
  const innerSvg = window.ICONS[name] || window.ICONS.target;
  return `<svg xmlns="http://www.w3.org/2000/svg" width="${size}" height="${size}" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather-icon ${className}">${innerSvg}</svg>`;
};
